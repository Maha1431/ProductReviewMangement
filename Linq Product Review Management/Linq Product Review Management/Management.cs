...
namespace Linq_Product_Review_Management
{
    public  class Management
    {
        ...
        {
            var fetchrecords = (from ProductReview in productReviews
                                where (ProductReview.Reviews == "nice")
                                select ProductReview);
            foreach (var list in fetchrecords)
            {
                Console.WriteLine("Reviews :" + list.Reviews);
            }
        }
